...
# -*- coding: utf-8 -*-
"""
Purpose: File to scrape and match the 'adjacion' information for each contract - similar to other file only more specialized
"""
...
def get_scraper(results,datos):
    ...
    try:
        ...
        scraped_data = scraping_cse_adj.process_resultpage(results,datos)
    except Exception as e:
